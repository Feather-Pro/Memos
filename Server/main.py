...
import json , os
from . import picture , gif , sound , video
...
@server.get('/')
async def home() :
    path =   os.path.join(base , "Home", "index.html")
    return FileResponse(path , media_type = 'text/html')

@server.get('/decore.css')
async def decore() :
      path =   os.path.join(base , "Home", "decore.css")
      return FileResponse(path , media_type = 'text/css')

@server.get('/code.js')
async def code() :
      path =   os.path.join(base , "Home", "code.js")
      return FileResponse(path , media_type = 'application/javascript')

@server.get('/Pictures/not-found.webp')
async def no_found() :
      path =   os.path.join(base , "Pictures", "not-found.webp")
...
async def picture_download(picture , i : str , t : str) :
      path =   os.path.join(base , "Download", "download.html")
      with open(path) as f :
